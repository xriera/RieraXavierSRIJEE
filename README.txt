...
a persistence unit "RieraXavierSRIJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "RieraXavierSRIJEE\pom.xml":
...
artifact ("RieraXavierSRIJEE.war") is already built. You can build
